          ...
          <div className="animate-on-scroll stagger-3">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="inline-flex h-12 w-full items-center justify-center rounded-lg bg-gradient-to-r from-primary-hover to-primary px-8 text-sm font-semibold text-primary-foreground shadow-md transition-all hover:scale-[1.02] hover:opacity-90 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:scale-100 sm:w-auto"
              >
